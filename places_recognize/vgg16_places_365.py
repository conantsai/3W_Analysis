...
def VGG16_Places365(include_top=True, weights='places',
    ...
    if weights == 'places':
        if include_top:
            weights_path = "places_recognize/vgg16_pretain_model/vgg16-places365_weights_tf_dim_ordering_tf_kernels.h5"
        else:
            weights_path = "places_recognize/vgg16_pretain_model/vgg16-places365_weights_tf_dim_ordering_tf_kernels_notop.h5"
...
if __name__ == '__main__':
    ...
    TEST_IMAGE = 'places365_class/6.jpg'
    ...
    file_name = 'places365_class/categories_places365.txt'
